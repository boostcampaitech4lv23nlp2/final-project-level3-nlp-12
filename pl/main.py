...
if __name__ == "__main__":
    ...
    cfg = OmegaConf.load(f"/opt/ml/final/pl/config/{args.config}.yaml")
    ...
    ck_dir_path = f"/opt/ml/final/pl/checkpoint/{model_name_ch}"
    ...
    pred = trainer.predict(model=model, datamodule=dataloader, ckpt_path="best")
