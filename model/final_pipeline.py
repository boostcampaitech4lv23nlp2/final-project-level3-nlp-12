...
def main():
    ...
    parser.add_argument("--input_video_path", default='/opt/ml/final/serving/input/video_1_honney.mp4')
    ...
    parser.add_argument("--sentiment_string",default="0 0 None 0 9 joy 9 19 disgust")
    ...
    merged_music_path = f'{args.output_dir}/merged_music.mp3' #merged_music / format 'mp3'
    merge_music(new_bgm, vocal_file_path, merged_music_path)
    video_music_merge(args.input_video_path, merged_music_path, args.output_dir)
    print(f'final video file created in {args.output_dir} directory')
